	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
			    document.getElementById("captchaImage").src="${pageContext.request.contextPath}/code/code?a="+Math.random();
			});
			
			//  form 表单提交
			/*$("#loginForm").bind("submit",function(result){
				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="adminName" class="text" value="" maxlength="20"/>
							</td>
					  </tr>
					  <tr>
							<th>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton" value="" onclick="location.href='${pageContext.request.contextPath}/Admin/login'"><input type="submit" class="loginButton" value="登录">
						</td>
					</tr>
				</tbody></table>
